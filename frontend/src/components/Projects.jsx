...
const projectsData = [
  {
    ...
    solution: 'Desarrollé un pipeline E2E diseñando procesos ETL desde MongoDB utilizando Python (Pandas/NumPy) y construyendo un panel administrativo automatizado.',
    ...
    tags: ['Python', 'Pandas', 'MongoDB', 'React', 'Dashboards'],
  ...
  },
  {
    id: 'support-pandas',
    title: 'SupportPandas',
    role: 'Sistema de Tickets Analítico',
  ...
  return (
    ...
    >
      ...
      <div className="relative h-60 w-full overflow-hidden bg-gray-100">
        ...
        />
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-primary text-xs font-bold px-3 py-1 rounded-full shadow-sm">
          {project.metric}
        </div>
      </div>
      ...
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-2xl font-bold text-text mb-1 group-hover:text-primary transition-colors">{project.title}</h3>
