        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-text-muted text-lg leading-relaxed">
              <p>
                Soy un analista de datos y desarrollador de software apasionado por la <strong>optimización</strong>. Me especializo en tomar datos desordenados y transformarlos en información medible y plataformas eficientes.
              </p>
              <p>
                Actualmente trabajo en <strong>Celtics TI</strong>, donde desarrollo soluciones internas y analizo datos para automatizar los procesos organizacionales minimizando el esfuerzo manual y los errores operativos. 
              </p>
              <p>
                Mi filosofía de trabajo es que la tecnología debe servir al negocio: cada línea de código y cada dashboard debe tener un propósito claro de ahorro de tiempo o maximización de beneficios. Estudio Ingeniería en Desarrollo y Gestión de Software, manteniendo un equilibrio constante entre la academia y la aplicación en el mundo real.
              </p>
            </div>
